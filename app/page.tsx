...
export default function LandingPage() {
  return (
    ...
    >
      {/* Header */}
      <header className="z-10 w-full max-w-6xl mx-auto flex items-center justify-between bg-[#e2e1e6] border-[3px] border-black shadow-[4px_4px_0px_rgba(0,0,0,0.35)] rounded-2xl px-6 py-4 text-black">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-black font-retro font-bold tracking-[0.2em] text-[12px] uppercase">HeavenVerse V2</span>
        </div>
      </header>
      ...
      <main className="z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center my-auto py-12 md:py-16">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/player" className="group relative px-8 py-4 bg-[#e63b3b] hover:bg-[#d82a2a] text-white font-retro font-bold rounded-2xl text-sm uppercase tracking-wider flex items-center gap-2.5 shadow-[4px_4px_0px_black] active:translate-y-0.5 active:shadow-none transition-all cursor-pointer border-2 border-black">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mt-20">
          {[
            {
              icon: <FolderUp className="w-6 h-6 text-black" />,
              title: "Local Import",
            ...
            {
              icon: <ListMusic className="w-6 h-6 text-black" />,
            ...
            <div
              key={i}
              className="bg-[#f9f8fa] border-[3px] border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] rounded-3xl p-6 text-left flex flex-col gap-3.5 hover:translate-y-[-4px] transition-transform text-black font-retro"
            >
              <div className="p-3 bg-[#e2e1e6] border-2 border-black rounded-2xl w-fit">
                {feat.icon}
              </div>
              <h3 className="font-bold text-sm tracking-wide uppercase text-black">{feat.title}</h3>
        ...
        <div className="w-full max-w-4xl mx-auto mt-20 border-[3px] border-black rounded-3xl overflow-hidden shadow-[6px_6px_0px_rgba(0,0,0,0.3)] bg-[#e2e1e6] font-retro text-black">
          <div className="px-6 py-4 border-b-2 border-black flex items-center justify-between bg-[#d5d4d9]">
      ...
      {/* Footer */}
      <footer className="z-10 w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 mt-8 bg-[#e2e1e6] border-2 border-black rounded-2xl px-6 py-4 text-xs text-black font-retro shadow-[3px_3px_0px_rgba(0,0,0,0.15)]">
        <p className="font-medium">
          Designed and Developed with <span className="text-red-500 animate-pulse inline-block">❤️</span> by{" "}
          <span className="text-black font-semibold">Vansh</span>
        </p>
